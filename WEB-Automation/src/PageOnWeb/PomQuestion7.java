...
public class PomQuestion7 {
	...
	private static void createTask()
	{
		try
		{
			...
			Thread.sleep(2000);
			oPage.getinputTask().sendKeys("Task1");
			Thread.sleep(6000);
			oPage.getclickOnCreateTaskButton().click();
			Thread.sleep(4000);
    ...
    @Test(priority=8)
 	private static void DeleteTask()
 	{
 		try
 		{
 			oPage.getselectTaskToDelete().click();
 			Thread.sleep(2000);
 			oPage.getdeletetaskactionbutton().click();
 			Thread.sleep(6000);
 			oPage.getdeletetaskbutton().click();
 			Thread.sleep(4000);
 			oPage.getdeletetaskconfirmbutton().click();
 			Thread.sleep(4000);
